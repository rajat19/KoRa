    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo_file', models.FileField(blank=True, upload_to='')),
        ...
        migrations.AddField(
            model_name='book',
            name='series',
            field=models.ForeignKey(blank=True, default='', null=True, on_delete=django.db.models.deletion.CASCADE, to='books.Series'),
        ),
    ]
